...
Route::namespace('Admin')->group(function () {
    ...
    Route::middleware(['Admin'])->group(function () {
        ...
        Route::post('update-image', [ProductController::class, 'updateImage'])->name('productUpdateGallery');
        Route::get('delete-image/{id}', [ProductController::class, 'deleteImage'])->name('productDeleteGallery');
