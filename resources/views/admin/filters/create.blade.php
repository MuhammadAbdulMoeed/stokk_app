    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <form method="post" id="categoryForm">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="form-group">
                            ...
                            <select name="filter_type" class="form-control filter_type">
                                ...
                                <option value="pre_included_filter">Pre-Included Filter</option>
                ...
                <div class="custom_filter_section" style="display: none">
                ...
                <div class="row price_range_section" style="display: none">
